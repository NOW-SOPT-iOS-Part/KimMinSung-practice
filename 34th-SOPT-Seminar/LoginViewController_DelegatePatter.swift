//
//  LoginViewController_DelegatePatter.swift
//  34th-SOPT-Seminar
//
...
class LoginViewController_Delegate_Pattern: UIViewController {
    ...
    private func presentToWelcomeVC() {
        let welcomeViewController_DelegatePtrn = WelcomeViewController_Delegate_Pattern()
        welcomeViewController_DelegatePtrn.modalPresentationStyle = .formSheet
        welcomeViewController_DelegatePtrn.id = self.idTextField.text
        
        welcomeViewController_DelegatePtrn.delegate = self
        
        self.present(welcomeViewController_DelegatePtrn, animated: true)
    }
    ...
    private func pushToWelcomeVC() {
        ...
        self.navigationController?.pushViewController(welcomeViewController_delegatePtrn, animated: true)
    }
